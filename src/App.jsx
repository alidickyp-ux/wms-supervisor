...
function App() {
  ...
  return (
    <div style={{ ...globalStyle, display: 'flex', minHeight: '100vh', backgroundColor: '#fff' }}>
      {/* SIDEBAR */}
      <div style={{ width: '200px', borderRight: '1px solid #eee', padding: '20px 0', position: 'fixed', height: '100vh', display: 'flex', flexDirection: 'column' }}>
        <div style={{ padding: '0 20px 20px 20px', borderBottom: '1px solid #f5f5f5', marginBottom: '15px' }}>
          <h2 style={{ fontSize: '0.9rem', fontWeight: '800', color: '#000', margin: 0 }}>COOL</h2>
          <p style={{ fontSize: '0.6rem', color: '#999', marginTop: '2px' }}>{user?.full_name}</p>
        </div>
        ...
        <button onClick={() => setIsLoggedIn(false)} style={{ border: 'none', background: 'none', color: '#ff4d4f', padding: '15px 20px', fontSize: '0.7rem', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', borderTop: '1px solid #eee', fontFamily: 'Lexend' }}>
          <LogOut size={14} /> Logout
        </button>
      </div>

      {/* MAIN CONTENT AREA */}
      <div style={{ flex: 1, padding: '25px 40px', marginLeft: '200px' }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input placeholder="Search..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} style={{ padding: '7px 10px 7px 30px', border: '1px solid #eee', borderRadius: '4px', fontSize: '0.75rem', width: '150px', outline: 'none', fontFamily: 'Lexend' }} />
            </div>
